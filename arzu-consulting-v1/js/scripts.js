document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            formData.append('action', 'arzu_contact_form');
            formData.append('nonce', arzuAjax.nonce);
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    successMessage.textContent = data.data.message || 'An error occurred. Please try again.';
                    successMessage.classList.add('show');
